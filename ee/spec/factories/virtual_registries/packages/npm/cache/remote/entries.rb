...
FactoryBot.define do
  factory :virtual_registries_packages_npm_cache_remote_entry,
    class: 'VirtualRegistries::Packages::Npm::Cache::Remote::Entry' do
    upstream { association :virtual_registries_packages_npm_upstream }
