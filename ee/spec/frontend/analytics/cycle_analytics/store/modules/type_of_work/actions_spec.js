...
import { groupLabels, groupLabelNames, endpoints } from '../../../mock_data';
...
describe('Type of work actions', () => {
  ...
  describe('fetchTopRankedGroupLabels', () => {
    ...
    describe('succeeds', () => {
      ...
      describe('receiveTopRankedGroupLabelsSuccess', () => {
        it(`commits the ${types.RECEIVE_TOP_RANKED_GROUP_LABELS_SUCCESS} mutation`, () => {
          return testAction(actions.receiveTopRankedGroupLabelsSuccess, null, state, [
            {
  ...
  describe('setTasksByTypeFilters', () => {
    ...
    it(`commits the ${types.SET_TASKS_BY_TYPE_FILTERS} mutation`, () => {
      return testAction(actions.setTasksByTypeFilters, { filter, value }, {}, [
        {
