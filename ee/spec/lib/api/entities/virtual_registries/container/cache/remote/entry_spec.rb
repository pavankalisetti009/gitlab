...
RSpec.describe API::Entities::VirtualRegistries::Container::Cache::Remote::Entry, feature_category: :virtual_registry do
  let(:cache_entry) { build_stubbed(:virtual_registries_container_cache_remote_entry) }
