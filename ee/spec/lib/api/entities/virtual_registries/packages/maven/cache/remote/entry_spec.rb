...
RSpec.describe API::Entities::VirtualRegistries::Packages::Maven::Cache::Remote::Entry, feature_category: :virtual_registry do
  let(:cache_entry) { build_stubbed(:virtual_registries_packages_maven_cache_remote_entry) }
