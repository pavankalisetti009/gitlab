...
RSpec.describe CloudConnector::DatabaseDataLoader, feature_category: :cloud_connector do
  ...
  describe '#load!' do
    context 'with valid catalog data' do
      ...
      it 'returns only instances of the model class' do
        expect(unit_primitive_loader.load!).to all(be_a(unit_primitive_class))
      end
