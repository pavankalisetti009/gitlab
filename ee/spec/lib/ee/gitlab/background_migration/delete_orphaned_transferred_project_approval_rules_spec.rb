...
RSpec.describe Gitlab::BackgroundMigration::DeleteOrphanedTransferredProjectApprovalRules, schema: 20230721095222, feature_category: :security_policy_management do
  describe '#perform' do
