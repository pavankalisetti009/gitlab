...
RSpec.describe(
  ...
  describe "#perform", feature_category: :vulnerability_management do
    ...
    context "when a Finding has no Vulnerability" do
      ...
      context "when there was a problem saving the Vulnerability" do # rubocop:disable RSpec/MultipleMemoizedHelpers -- needed in specs
        ...
        it "doesn't create a Vulnerability record" do
          expect { migration }.to change { vulnerabilities.count }.by(0)
        end
      ...
      it 'creates a Vulnerability from the Vulnerabilities::Finding' do
        expect { migration }.to change { vulnerabilities.count }.by(1)
      end
    ...
    context "when there's only a Security::Finding" do
      before do
        ...
        # rubocop:disable RSpec/FactoriesInMigrationSpecs -- can't handle this otherwise without a ton of code
      ...
      context "when creating any associated record fails" do # rubocop:disable RSpec/MultipleMemoizedHelpers -- needed in spec
        ...
        # rubocop:disable RSpec/InstanceVariable -- needed in spec
        it "logs an error" do
          expect_next_instance_of(::Gitlab::BackgroundMigration::Logger) do |logger|
            params = {
    ...
    context "when a Vulnerability is dismissed" do
      ...
      context 'when the StateTransition is invalid' do # rubocop:disable RSpec/MultipleMemoizedHelpers -- needed in spec
        ...
        it "doesn't create a StateTransition" do
          expect { migration }.not_to change { vulnerability_state_transitions.count }
        end
    ...
    # rubocop:disable RSpec/MultipleMemoizedHelpers -- needed in spec
