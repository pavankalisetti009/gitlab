                      ...
                      sources: [
                        {
                          configMap: {
                            ...
                            items: [
                              {
                                key: "gl-internal-example-command-1",
                                path: "tooling-container/gl-internal-example-command-1"
                              },
                              {
                                key: "gl-internal-example-command-2",
                                path: "tooling-container/gl-internal-example-command-2"
                              },
                              {
