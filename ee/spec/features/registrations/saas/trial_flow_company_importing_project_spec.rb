...
RSpec.describe 'Trial flow for user picking company and importing a project', :js, :saas_registration, :with_current_organization, feature_category: :onboarding do
