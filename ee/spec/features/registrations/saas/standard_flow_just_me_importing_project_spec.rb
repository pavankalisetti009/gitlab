...
RSpec.describe 'Standard flow for user picking just me and importing a project', :js, :saas_registration, :with_current_organization, feature_category: :onboarding do
