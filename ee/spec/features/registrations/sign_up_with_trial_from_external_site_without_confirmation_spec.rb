...
RSpec.describe 'Sign up with trial from external site without confirmation', :with_trial_types, :saas, :js, :with_current_organization, feature_category: :onboarding do
