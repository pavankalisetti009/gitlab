...
RSpec.describe 'Admin::AuditLogs', :js, feature_category: :audit_events do
  ...
  context 'licensed' do
    ...
    context 'with feature flag enabled' do
      ...
      describe 'filter by date' do
        let_it_be(:audit_event_1) { create(:audit_events_user_audit_event, created_at: 5.days.ago) }
        let_it_be(:audit_event_2) { create(:audit_events_user_audit_event, created_at: 3.days.ago) }
        let_it_be(:audit_event_3) { create(:audit_events_user_audit_event, created_at: Date.current) }
        let_it_be(:events_path) { :admin_audit_logs_path }
        let_it_be(:entity) { nil }
