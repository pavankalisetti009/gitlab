...
RSpec.describe 'Project security discover page', :js, :saas, feature_category: :groups_and_projects do
    ...
    shared_examples 'move personal project modal content' do
      it 'loads the modal with correct content' do
        ...
        expect(page).to have_link(
          ...
          href: help_page_path('tutorials/move_personal_project_to_group/index')
        )
      end
    end
