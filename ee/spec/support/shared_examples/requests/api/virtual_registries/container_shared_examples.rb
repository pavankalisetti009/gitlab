...
RSpec.shared_examples 'container virtual registry disabled dependency proxy' do
  before do
...
RSpec.shared_examples 'container virtual registry not authenticated user' do
  let(:headers) { {} }
...
RSpec.shared_examples 'an authenticated container virtual registry REST API' do |with_successful_status: :ok|
