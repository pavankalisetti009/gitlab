  ...
  describe '#policy_configuration_validation_errors' do
    ...
    describe "approval policies" do
      ...
      context "with license_finding type" do
        ...
        describe 'enforcement_type and license_finding rule validation' do
          let(:policy_yaml) do
            {
              approval_policy: [
                {
          ...
          context 'when enforcement_type is "warn"' do
            ...
            it 'is invalid when rules contain license_finding type' do
              expect(errors).to contain_exactly(
                "property '/approval_policy/0/rules/0/type' is not one of: [\"scan_finding\", \"any_merge_request\"]")
            end
          end
          ...
          context 'when enforcement_type is "enforce"' do
            ...
            it 'is valid when rules contain license_finding type' do
              expect(errors).to be_empty
            end
          end

          context 'when enforcement_type is not specified (defaults to "enforce")' do
            let(:policy_yaml) do
              {
                approval_policy: [
                  {
          ...
          context 'when enforcement_type is "warn" but rules do not contain license_finding' do
            let(:policy_yaml) do
              {
                approval_policy: [
                  {
          ...
          context 'with multiple policies where some have warn enforcement and license_finding' do
            let(:policy_yaml) do
              {
                approval_policy: [
                  {
            ...
            it 'is invalid due to the policy with warn enforcement and license_finding' do
              expect(errors).to contain_exactly(
                "property '/approval_policy/1/rules/0/type' is not one of: [\"scan_finding\", \"any_merge_request\"]")
            end
          end
        end
      end
