...
RSpec.describe GitlabSubscriptions::Duo, feature_category: :"add-on_provisioning" do
  ...
  describe '.self_managed_agent_fully_enabled?' do
    subject { described_class.self_managed_agent_fully_enabled? }
    ...
    before do
      ...
      stub_application_setting(instance_level_ai_beta_features_enabled: instance_level_ai_beta_features_enabled)
      ::Ai::Setting.instance.update!(duo_core_features_enabled: duo_core_features_enabled)
    end

    using RSpec::Parameterized::TableSyntax

    where(:duo_default_on, :instance_level_ai_beta_features_enabled, :duo_core_features_enabled, :expected_result) do
      true  | true  | true  | true
  ...
  describe '.self_managed_enabled_without_beta_features?' do
    subject { described_class.self_managed_enabled_without_beta_features? }
  ...
  describe '.self_managed_only_duo_default_off?' do
    subject { described_class.self_managed_only_duo_default_off? }
  ...
  describe '.self_managed_enabled_without_core?' do
    subject { described_class.self_managed_enabled_without_core? }
