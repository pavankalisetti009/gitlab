  ...
  describe 'GET projects/:id/audit_events' do
    ...
    context 'when authenticated, as a member' do
      ...
      context 'cursor compatibility across FF toggles', :freeze_time do
        let!(:old_table_event_1) { create(:project_audit_event, created_at: 4.days.ago, entity_id: project.id, author_id: user.id) }
        let!(:old_table_event_2) { create(:project_audit_event, created_at: 3.days.ago, entity_id: project.id, author_id: user.id) }
        let!(:old_table_event_3) { create(:project_audit_event, created_at: 2.days.ago, entity_id: project.id, author_id: user.id) }
        let!(:old_table_event_4) { create(:project_audit_event, created_at: 1.day.ago, entity_id: project.id, author_id: user.id) }

        let!(:new_table_event_1) { create(:audit_events_project_audit_event, id: old_table_event_1.id, created_at: 4.days.ago, project_id: project.id, author_id: user.id) }
        let!(:new_table_event_2) { create(:audit_events_project_audit_event, id: old_table_event_2.id, created_at: 3.days.ago, project_id: project.id, author_id: user.id) }
        let!(:new_table_event_3) { create(:audit_events_project_audit_event, id: old_table_event_3.id, created_at: 2.days.ago, project_id: project.id, author_id: user.id) }
        let!(:new_table_event_4) { create(:audit_events_project_audit_event, id: old_table_event_4.id, created_at: 1.day.ago, project_id: project.id, author_id: user.id) }
