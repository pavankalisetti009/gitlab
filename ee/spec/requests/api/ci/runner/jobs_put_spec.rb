...
RSpec.describe API::Ci::Runner, :clean_gitlab_redis_shared_state, feature_category: :runner_core do
  ...
  describe 'PUT /api/v4/jobs/:id' do
    ...
    context 'when compute minutes usage is not exceeded' do
