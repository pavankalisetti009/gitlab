...
RSpec.describe 'Query.addOnPurchases', feature_category: :seat_cost_management do
  ...
  context 'when namespace_id is not provided as argument' do
    ...
    context 'when active purchases exist' do
      let_it_be(:add_on_purchase_1) do
        create(:gitlab_subscription_add_on_purchase, :gitlab_duo_pro, :active, namespace_id: nil)
      end

      let_it_be(:add_on_purchase_2) do
        create(:gitlab_subscription_add_on_purchase, :duo_enterprise, :active, namespace_id: nil)
      end
    ...
    context 'when active purchases do not exist' do
      before do
        create(:gitlab_subscription_add_on_purchase, :gitlab_duo_pro, :expired, namespace_id: nil)
      end
  ...
  context 'when namespace_id is provided as an argument' do
    ...
    context 'when active purchases exist' do
      let_it_be(:add_on_purchase_1) do
        create(:gitlab_subscription_add_on_purchase, :gitlab_duo_pro, :active, namespace_id: group.id)
      end

      let_it_be(:add_on_purchase_2) do
        create(:gitlab_subscription_add_on_purchase, :duo_enterprise, :active, namespace_id: group.id)
      end
    ...
    context 'when active purchases do not exist' do
      before do
        create(:gitlab_subscription_add_on_purchase, :gitlab_duo_pro, :expired, namespace_id: group.id)
      end
