...
RSpec.describe 'Setting Group Validity Checks', feature_category: :security_testing_configuration do
  include GraphqlHelpers

  let(:mutation_name) { 'SetGroupValidityChecks' }
  ...
  let(:mutation_params) do
    {
      ...
      validity_checks_enabled: enable
    }
  end
  ...
  describe 'projects of a group by toggling validity checks' do
    context 'with group' do
      before do
        allow(::Security::Configuration::SetGroupValidityChecksWorker).to receive(:perform_async)
      end
      ...
      context 'when user is not a member of the group' do
        ...
        it 'does not call the worker' do
          ...
          expect(::Security::Configuration::SetGroupValidityChecksWorker)
