...
RSpec.describe 'Destroy a upstream cache', :sidekiq_inline, feature_category: :virtual_registry do
  ...
  def upstream_cache_delete_mutation(params = mutation_params)
    graphql_mutation(:containerUpstreamCacheDelete, params)
  end
  ...
  context 'when mutation params are invalid' do
    it_behaves_like 'returning error message' do
      ...
      let(:error_msg) do
        "Variable $containerUpstreamCacheDeleteInput of type ContainerUpstreamCacheDeleteInput! " \
