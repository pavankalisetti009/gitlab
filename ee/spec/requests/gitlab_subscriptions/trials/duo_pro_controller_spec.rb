...
RSpec.describe GitlabSubscriptions::Trials::DuoProController, :saas, :unlimited_max_formatted_output_length, feature_category: :acquisition do
    ...
    context 'when authenticated' do
      ...
      context 'when successful' do
        ...
        def expect_create_success
          ...
          expect_next_instance_of(GitlabSubscriptions::Trials::DuoProCreateService, service_params) do |instance|
      ...
      context 'with create service failures' do
        ...
        def expect_create_failure(reason, payload = {})
          ...
          expect_next_instance_of(GitlabSubscriptions::Trials::DuoProCreateService) do |instance|
