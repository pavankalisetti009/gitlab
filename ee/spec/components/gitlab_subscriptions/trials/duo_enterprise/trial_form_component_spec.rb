...
RSpec.describe GitlabSubscriptions::Trials::DuoEnterprise::TrialFormComponent, :aggregate_failures, feature_category: :acquisition do
  ...
  context 'with default content' do
    ...
    it { is_expected.to have_content(s_('DuoEnterpriseTrial|Start your free GitLab Duo Enterprise trial')) }
    ...
    it 'has advantages section' do
      is_expected.to have_content(s_('DuoEnterpriseTrial|GitLab Duo Enterprise is your end-to-end'))
    end
  end
