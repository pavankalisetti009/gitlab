...
require 'spec_helper'
require File.expand_path('ee/elastic/migrate/20250502033928_backfill_vulnerabilities.rb')

RSpec.describe BackfillVulnerabilities, feature_category: :vulnerability_management do
  let(:version) { 20250502033928 }
