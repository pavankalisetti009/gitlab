...
RSpec.describe RemoveEpicsIndex, :elastic_helpers, feature_category: :global_search do
  let(:version) { 20251024000709 }
  let(:helper) { Gitlab::Elastic::Helper.new }
  let(:index_name) { described_class::EPICS_INDEX_NAME }
