...
require 'spec_helper'
require File.expand_path('ee/elastic/migrate/20250423163248_reindex_work_items_to_update_integer_with_long_type.rb')

RSpec.describe ReindexWorkItemsToUpdateIntegerWithLongType, feature_category: :global_search do
  let(:version) { 20250423163248 }
