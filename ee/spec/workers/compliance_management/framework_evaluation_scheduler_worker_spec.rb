...
RSpec.describe ComplianceManagement::FrameworkEvaluationSchedulerWorker, feature_category: :compliance_management do
  describe '#perform' do
    ...
    shared_examples 'performs framework evaluations' do
    ...
    context 'when optimize_framework_worker_query feature flag is disabled' do
      before do
        stub_feature_flags(optimize_framework_worker_query: false)
      end

      it_behaves_like 'performs framework evaluations'
    end

    context 'when optimize_framework_worker_query feature flag is enabled' do
      before do
        stub_feature_flags(optimize_framework_worker_query: true)
      end
