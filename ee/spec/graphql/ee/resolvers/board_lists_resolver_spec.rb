...
RSpec.describe Resolvers::BoardListsResolver, feature_category: :portfolio_management do
  ...
  shared_examples_for 'group and project board lists resolver' do
    ...
    it 'returns a list of board lists' do
      ...
      expect(lists.map(&:list_type)).to eq %w[backlog closed assignee milestone]
    end
  end
