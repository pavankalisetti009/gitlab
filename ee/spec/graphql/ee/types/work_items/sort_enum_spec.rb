...
RSpec.describe GitlabSchema.types['WorkItemSort'], feature_category: :team_planning do
  ...
  it 'exposes all the existing work item sort values' do
    expect(described_class.values.keys).to match_array(
      %w[
        ...
        BLOCKING_ITEMS_ASC BLOCKING_ITEMS_DESC HEALTH_STATUS_ASC HEALTH_STATUS_DESC WEIGHT_ASC WEIGHT_DESC
      ]
    )
  end
end
