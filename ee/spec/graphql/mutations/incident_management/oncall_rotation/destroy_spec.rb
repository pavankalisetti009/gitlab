...
RSpec.describe Mutations::IncidentManagement::OncallRotation::Destroy, feature_category: :on_call_schedule_management do
  ...
  describe '#resolve' do
    subject(:resolve) { mutation_for(project).resolve(**args) }
