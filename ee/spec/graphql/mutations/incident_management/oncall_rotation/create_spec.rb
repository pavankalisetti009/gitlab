...
RSpec.describe Mutations::IncidentManagement::OncallRotation::Create, feature_category: :on_call_schedule_management do
  ...
  describe '#resolve' do
    subject(:resolve) do
      described_class
        ...
        .resolve(iid: schedule.iid, project_path: project.full_path, participants: args[:participants], **args)
    end
