...
RSpec.describe ComplianceManagement::Standards::Gitlab::DastService,
  ...
  describe '#execute' do
    ...
    context 'when group_level_compliance_dashboard feature is available' do
      ...
      context 'when project has failed pipeline for default branch with dast artifacts' do
      ...
      context 'when project has security_orchestration_policy pipeline with dast artifacts' do
        ...
        before do
          ...
          create(:ee_ci_job_artifact, :dast, project: project, job: ci_build)
        end
      ...
      context 'when project has parent_pipeline with dast artifacts' do
      ...
      context 'when project has webide pipeline with dast artifacts' do
      ...
      context 'when project has ondemand_dast_scan pipeline with dast artifacts' do
