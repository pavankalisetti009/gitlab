...
RSpec.describe Ai::Catalog::Agents::DestroyService, feature_category: :workflow_catalog do
  it_behaves_like Ai::Catalog::Items::BaseDestroyService do
    let_it_be_with_reload(:incorrect_item_type) { create(:ai_catalog_flow, :with_version, project: project) }
    let!(:item) { create(:ai_catalog_agent, :with_version, project: project) }
