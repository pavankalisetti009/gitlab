  ...
  describe '#execute', :freeze_time do
    ...
    it 'creates an audit event', :aggregate_failures do
      ...
      expect(audit_events[0].details).to include(
        custom_message: 'Created a new public AI agent with tools: [gitlab_blob_search]',
        event_name: 'create_ai_catalog_agent',
      ...
      expect(audit_events[1].details).to include(
        custom_message: 'Released version 1.0.0 of AI agent'
      )
    end
