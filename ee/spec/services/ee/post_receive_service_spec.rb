...
RSpec.describe PostReceiveService, :geo, feature_category: :source_code_management do
          ...
          expect(subject).to match_array([
            {
              "message" =>
                <<~MSG.squish,
                  ...
                  see our docs: http://localhost/help/user/storage_usage_quotas.md#project-storage-limit.
                MSG
              "type" => "alert"
            }
          ])
        ...
        context 'with a personal namespace' do
          ...
          it 'returns warning message' do
            expect(subject).to match_array([{ "message" => "##### WARNING ##### You have used 96% of the storage quota for #{project.namespace.name} " \
                                                           ...
                                                           "see http://localhost/help/user/storage_usage_quotas.md#manage-storage-usage. " \
