...
module EE
  module WorkItemsHelper
    ...
    def work_items_data(resource_parent, current_user)
      ...
      super.merge(
        duo_remote_flows_enabled: duo_remote_flows_enabled(resource_parent).to_s,
    ...
    def duo_remote_flows_enabled(resource_parent)
      return false if resource_parent.is_a?(Group)

      resource_parent.respond_to?(:duo_remote_flows_enabled) && resource_parent.duo_remote_flows_enabled
    end
