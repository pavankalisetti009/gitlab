  ...
  module IssuesHelper
    ...
    def common_issues_list_data(namespace, current_user)
      super.merge(
        ...
        has_custom_fields_feature: namespace.licensed_feature_available?(:custom_fields).to_s,
    ...
    def project_issues_list_data(project, current_user)
      super.tap do |data|
        data[:duo_remote_flows_availability] = project.duo_remote_flows_enabled.to_s
