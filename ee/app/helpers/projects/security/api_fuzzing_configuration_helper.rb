  ...
  def api_fuzzing_configuration_data(project)
    {
      ...
      api_fuzzing_documentation_path: help_page_path('user/application_security/api_fuzzing/index.md'),
      ...
      ci_variables_documentation_path: help_page_path('ci/variables/index.md'),
