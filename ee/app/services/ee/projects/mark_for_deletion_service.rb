    ...
    module MarkForDeletionService
      ...
      def execute(*)
        ...
        unless License.feature_available?(:adjourned_deletion_for_projects_and_groups)
          return error('Cannot mark project for deletion: feature not supported')
        end
      ...
      def project_update_service_params
        ...
        params[:hidden] = true unless project.licensed_feature_available?(:adjourned_deletion_for_projects_and_groups)
        params
      end
