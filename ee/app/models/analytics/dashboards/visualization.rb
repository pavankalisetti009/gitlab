  ...
  module Dashboards
    class Visualization
      ...
      def self.value_stream_dashboard_visualizations(container, is_project = false)
        unsafe_load_builtin_visualizations(VALUE_STREAM_DASHBOARD_VISUALIZATIONS,
          VALUE_STREAM_DASHBOARD_PATH, container, is_project)
      end
      ...
      def self.duo_usage_visualizations(container, is_project = false)
        unsafe_load_builtin_visualizations(DUO_USAGE_VISUALIZATIONS, DUO_USAGE_VISUALIZATIONS_PATH, container,
          is_project)
      end
      ...
      def self.builtin_visualizations(container, user)
        ...
        if container.duo_usage_dashboard_enabled?(user)
          visualizations << duo_usage_visualizations(container,
            is_project)
        end
