...
module EE
  module Plan
    ...
    prepended do
      ...
      # TODO remove PLANS_ELIGIBLE_FOR_COMBINED_TRIAL and replace with PLANS_ELIGIBLE_FOR_TRIAL after
      # duo_enterprise_trial feature flag is removed.
      PLANS_ELIGIBLE_FOR_COMBINED_TRIAL = (PLANS_ELIGIBLE_FOR_TRIAL | [PREMIUM]).freeze
