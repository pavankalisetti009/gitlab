...
module EE
  module ProjectPolicy
    ...
    prepended do
      ...
      condition(:agentic_chat_allowed) do
      ...
      rule { can?(:access_duo_chat) & duo_agentic_chat_enabled & agentic_chat_allowed & ~model_pinned_for_duo_chat & ~amazon_q_enabled }.policy do
