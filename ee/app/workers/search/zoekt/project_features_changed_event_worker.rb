...
module Search
  module Zoekt
    class ProjectFeaturesChangedEventWorker
      ...
      def handle_event(event)
        ...
        return if project_id.blank? || event.data[:features].exclude?('repository_access_level')
        ...
        log_extra_metadata_on_done(:project_id_reindexed_for_access_level_change, project_id)
      end
    end
  end
end
