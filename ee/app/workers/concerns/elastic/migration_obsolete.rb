  ...
  module MigrationObsolete
    def migrate
      log "Migration has been deleted in the last major version upgrade. " \
        ...
        "To correct this issue, recreate your index from scratch: https://docs.gitlab.com/ee/integration/elasticsearch/troubleshooting/indexing.html#last-resort-to-recreate-an-index."
