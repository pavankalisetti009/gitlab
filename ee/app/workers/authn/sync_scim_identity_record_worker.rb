...
module Authn
  class SyncScimIdentityRecordWorker
    ...
    def perform(args)
      ...
      group_scim_identity = GroupScimIdentity.find_or_initialize_by(temp_source_id: scim_identity.id) # rubocop:disable CodeReuse/ActiveRecord -- temporary worker for the purpose of syncing
      return unless group_scim_identity.new_record? || scim_identity.updated_at > group_scim_identity.updated_at
