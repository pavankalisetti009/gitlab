...
module Authn
  class SyncGroupScimIdentityRecordWorker
    ...
    def perform(args = {})
      ...
      scim_identity = ScimIdentity.find_or_initialize_by(id: group_scim_identity.temp_source_id) # rubocop:disable CodeReuse/ActiveRecord -- temporary worker for the purpose of syncing
      return unless scim_identity.new_record? || group_scim_identity.updated_at > scim_identity.updated_at
      ...
      scim_identity.save!
      group_scim_identity.update!(temp_source_id: scim_identity.id)
    end
  end
end
