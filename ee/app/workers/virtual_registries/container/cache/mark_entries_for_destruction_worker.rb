  ...
  module Container
    module Cache
      class MarkEntriesForDestructionWorker
        ...
        urgency :low
        defer_on_database_health_signal :gitlab_main, [:virtual_registries_container_cache_entries], 5.minutes
        deduplicate :until_executed
        idempotent!

        def perform(upstream_id)
          upstream = ::VirtualRegistries::Container::Upstream.find_by_id(upstream_id)
