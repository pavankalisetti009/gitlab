...
<template>
  <gl-tab :title="__('Details')">
    ...
    <dl class="gl-mb-8">
      ...
      <dd class="gl-text-gray-700 gl-mt-3 gl-mb-6" data-testid="id-value">{{ roleId }}</dd>

      <dt data-testid="type-header">{{ s__('MemberRole|Role type') }}</dt>
      <dd class="gl-text-gray-700 gl-mt-3 gl-mb-6" data-testid="type-value">{{ roleType }}</dd>

      <dt data-testid="description-header">{{ __('Description') }}</dt>
      <dd class="gl-text-gray-700 gl-mt-3 gl-leading-20" data-testid="description-value">
        {{ role.description }}
      </dd>
    </dl>
    ...
    <dl>
      ...
      <dd class="gl-text-gray-700 gl-mt-3 gl-mb-6 gl-flex gl-gap-x-5">
      ...
      <template v-if="isCustomRole">
        ...
        <dd
          ...
          class="gl-text-gray-700 gl-mt-3 gl-mb-6"
