...
export const DISABLE_SUCCESS = {
  ...
  [AI_CATALOG_TYPE_THIRD_PARTY_FLOW]: s__('AICatalog|Agent disabled in this %{namespaceType}.'),
};
export const DISABLE_ERROR = {
  ...
  [AI_CATALOG_TYPE_THIRD_PARTY_FLOW]: s__('AICatalog|Failed to disable agent'),
};
