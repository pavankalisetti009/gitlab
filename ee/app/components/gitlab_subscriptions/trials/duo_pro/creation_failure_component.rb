    ...
    module DuoPro
      class CreationFailureComponent < ViewComponent::Base
        ...
        def component_instance
          case result.reason
          when GitlabSubscriptions::Trials::DuoProCreateService::LEAD_FAILED
            ResubmitComponent.new(
              hidden_fields: lead_failed_hidden_fields,
              submit_path: submit_path(GitlabSubscriptions::Trials::DuoProCreateService::RESUBMIT_LEAD)
            ).with_content(result.errors.to_sentence)
          else
            ResubmitComponent.new(
              hidden_fields: trial_failed_hidden_fields,
              submit_path: submit_path(GitlabSubscriptions::Trials::DuoProCreateService::RESUBMIT_TRIAL)
