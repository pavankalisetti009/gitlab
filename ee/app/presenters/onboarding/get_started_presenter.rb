...
module Onboarding
  class GetStartedPresenter
    ...
    def code_section
      {
        title: s_('GetStarted|Set up your code'),
        description: s_('GetStarted|Use the Web IDE or upload code using your preferred method.'),
        actions: [
          {
            title: s_('GetStarted|Create a repository'),
            trackLabel: 'create_a_repository',
            url: url_helpers.project_path(project),
            completed: action_completed?(:created)
          },
          {
            title: s_('GetStarted|Add code to a repository'),
            trackLabel: 'add_code',
    ...
    def project_section
      {
        title: s_('GetStarted|Configure a project'),
        description: s_("GetStarted|Complete these tasks first so you can enjoy GitLab's features to their fullest."),
        actions: [
          {
            title: s_('GetStarted|Invite your colleagues'),
          ...
          {
            title: s_("GetStarted|Set up your first project's CI/CD"),
          ...
          {
            title: s_('GetStarted|Start a free trial of GitLab Ultimate'),
        ...
        trialActions: [
          {
            title: s_('GetStarted|Assign a GitLab Duo seat to your colleagues'),
          ...
          {
            title: s_('GetStarted|Add code owners'),
          ...
          {
            title: s_('GetStarted|Enable require merge approvals'),
    ...
    def plan_section
      {
        title: s_('GetStarted|Plan and execute work together'),
        description: s_("GetStarted|Create a workflow, and learn how GitLab features work together."),
        actions: [
          {
            title: s_('GetStarted|Create an issue'),
            trackLabel: 'create_an_issue',
            url: url_helpers.project_issues_path(project),
            completed: action_completed?(:issue_created)
          },
          {
            title: s_('GetStarted|Submit a merge request (MR)'),
    ...
    def secure_deployment_section
      {
        title: s_('GetStarted|Secure your deployment'),
        descriptionIcon: 'license',
        description: s_(
          'GetStarted|Included in trial. Use GitLab to deploy your application, monitor its health, ' \
            'and keep it secure.'
        ),
        actions: [
          {
            title: s_('GetStarted|Scan dependencies for licenses'),
          ...
          {
            title: s_('GetStarted|Scan dependencies for vulnerabilities'),
          ...
          {
            title: s_('GetStarted|Analyze your application for vulnerabilities with DAST'),
