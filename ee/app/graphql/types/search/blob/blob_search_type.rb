  ...
  module Search
    module Blob
      ...
      class BlobSearchType < BaseObject
        ...
        field :file_count, GraphQL::Types::Int, null: true, alpha: { milestone: '17.2' },
          description: 'Total number of files with matches.'
        field :files, [::Types::Search::Blob::FileType], null: true, alpha: { milestone: '17.2' },
          description: 'List of files with matches.'
        field :match_count, GraphQL::Types::Int, null: true, alpha: { milestone: '17.2' },
          description: 'Total number of matches.'
        field :per_page, GraphQL::Types::Int, null: true, alpha: { milestone: '17.2' },
        ...
        field :search_level, ::Types::Search::SearchLevelEnum, null: true, alpha: { milestone: '17.2' },
          description: 'Level of search performed.'
        field :search_type, ::Types::Search::SearchTypeEnum, null: true, alpha: { milestone: '17.2' },
