...
class AddEmbedding1ToWorkItemsElastic < Elastic::Migration
  ...
  def new_mappings
    { embedding_1: work_item_proxy.elastic_knn_field }
  end
...
AddEmbedding1ToWorkItemsElastic.prepend ::Search::Elastic::MigrationObsolete
