...
module RemoteDevelopment
  module WorkspaceOperations
    module Reconcile
      module Output
        # TODO: This is file is to be moved to ../../create/desired_config/desired_config_generator.rb in this issue:
        #  It's not yet moved because there are multiple files to be moved.
        #  https://gitlab.com/gitlab-org/gitlab/-/issues/541907
        class CreateDesiredConfigGenerator
          ...
          # TODO: Make all of these functions private by the end of https://gitlab.com/gitlab-org/gitlab/-/issues/541907
          #  These are kept public for now to allow access to DesiredConfigGenerator
        end
      end
    end
  end
