      ...
      module ProtectedBranchesHelpers
        ...
        prepended do
          ...
          params :optional_params_ee do
            ...
            optional :allowed_to_merge, type: Array[JSON], desc: 'An array of users/groups allowed to merge' do
              optional :access_level, type: Integer, values: ::ProtectedBranch::MergeAccessLevel.allowed_access_levels

              use :shared_params
            end

            optional :allowed_to_unprotect, type: Array[JSON], desc: 'An array of users/groups allowed to unprotect' do
