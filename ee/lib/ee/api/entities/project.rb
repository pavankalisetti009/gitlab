    ...
    module Entities
      module Project
        ...
        prepended do
          ...
          expose :auto_duo_code_review_enabled, if: ->(project, _) { project.auto_duo_code_review_settings_available? }
          ...
          expose :duo_sast_vr_workflow_enabled, if: ->(project, _) { project.licensed_feature_available?(:ai_features) && ::Feature.enabled?(:enable_vulnerability_resolution, project) }
