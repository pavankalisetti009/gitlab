    ...
    module Container
      class Registries < ::API::Base
        ...
        resource :groups, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
          ...
          namespace ':id/-/virtual_registries/container/registries' do
            desc 'Get the list of all container virtual registries' do
              ...
              success ::API::Entities::VirtualRegistries::Container::Registry
              failure [
            ...
            get do
              ...
              registries = ::VirtualRegistries::Container::Registry.for_group(group)

              present registries, with: ::API::Entities::VirtualRegistries::Container::Registry
            end

            desc 'Create a new container virtual registry' do
              detail 'This feature was introduced in GitLab 18.4. \
                  This feature is currently in an experimental state. \
                  This feature is behind the `container_virtual_registries` feature flag.'
              success ::API::Entities::VirtualRegistries::Container::Registry
            ...
            params do
              requires :name, type: String, desc: 'The name of the container virtual registry',
                allow_blank: false
            ...
            post do
              ...
              new_reg = ::VirtualRegistries::Container::Registry
                          .new(declared_params(include_missing: false).merge(group:))

              render_validation_error!(new_reg) unless new_reg.save

              present new_reg, with: ::API::Entities::VirtualRegistries::Container::Registry
            end
          end
        end

        namespace 'virtual_registries/container/registries' do
          route_param :id, type: Integer, desc: 'The ID of the container virtual registry' do
            desc 'Get a specific container virtual registry' do
              detail 'This feature was introduced in GitLab 18.4. \
                This feature is currently in an experimental state. \
                This feature is behind the `container_virtual_registries` feature flag.'
              success ::API::Entities::VirtualRegistries::Container::Registry
            ...
            get do
              ...
              present registry, with: Entities::VirtualRegistries::Container::Registry,
                with_registry_upstreams: true, exclude_registry_id: true
            end

            desc 'Update a specific container virtual registry' do
              detail 'This feature was introduced in GitLab 18.4. \
            ...
            params do
              with(allow_blank: false) do
                optional :name, type: String, desc: 'The name of the container virtual registry'
                optional :description, type: String, desc: 'The description of the container virtual registry'
              end
            ...
            desc 'Delete a specific container virtual registry' do
              detail 'This feature was introduced in GitLab 18.4. \
                This feature is currently in an experimental state. \
                This feature is behind the `container_virtual_registries` feature flag.'
              success code: 204
