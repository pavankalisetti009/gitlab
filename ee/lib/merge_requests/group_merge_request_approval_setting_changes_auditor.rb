...
module MergeRequests
  class GroupMergeRequestApprovalSettingChangesAuditor < ::AuditEvents::BaseChangesAuditor
    ...
    def audit_change(column, description)
      if model.previously_new_record?
        ...
        audit_changes(column, as: description, entity: @group,
          model: model, event_type: event_name(column))
      end
    end
