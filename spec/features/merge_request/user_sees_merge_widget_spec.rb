...
RSpec.describe 'Merge request > User sees merge widget', :js, feature_category: :code_review_workflow do
  ...
  context 'view merge request where fast-forward merge is not possible' do
    ...
    it 'there is no error' do
      ...
      expect(page).not_to have_content('Fast-forward merge is not possible. Please rebase or use a merge train.')
    end
    ...
    context 'when ff is off' do
      ...
      it 'shows information about the merge error' do
        ...
        expect(page).to have_content('Fast-forward merge is not possible. Please rebase or use a merge train.')
      end
    end
  end
