...
on September 29th 2025. Brownouts taking down images temporarily have started August 28th 2025.
...
repository. However, unpatched GitLab chart environments (GitLab 17.11, 18.0.5. 18.1.4,
...
If you're running an affected GitLab chart configuration, you need to take action by
either migrating to a supported GitLab reference architecture, upgrading to a patched
chart version, or by [configuring the legacy repository in your chart values][https://gitlab.com/gitlab-org/charts/gitlab/-/merge_requests/4421].

Looking ahead, [we will assess alternatives](https://gitlab.com/gitlab-org/charts/gitlab/-/issues/6089) to replace or potentially remove Bitnami
components from the GitLab chart entirely. For more information, see the
