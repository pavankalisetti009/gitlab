...
- On the left sidebar, select **Search or go to** then, from the dropdown list, select **Merge requests I'm working on**. If you've [turned on the new navigation](../../../interface_redesign.md), this field is on the top bar.
