...
| [GitLab Duo for the CLI](https://docs.gitlab.com/cli/duo/ask/) | {{< icon name="dash-circle" >}} No | {{< icon name="dash-circle" >}} No | {{< icon name="check-circle-filled" >}} Yes | {{< icon name="check-circle-filled" >}} Yes <sup>2</sup> |
