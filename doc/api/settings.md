...
| `allow_immediate_namespaces_deletion`    | boolean           | no                                   | Allow immediate deletion for groups or projects scheduled for deletion. [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/205556) in GitLab 18.5. Behind a [feature flag](../administration/feature_flags/_index.md) named `allow_immediate_namespaces_deletion`. Enabled by default, disabled on GitLab.com and Dedicated. |
