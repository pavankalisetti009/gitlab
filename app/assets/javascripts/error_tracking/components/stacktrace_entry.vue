...
<template>
  <div class="file-holder">
    <div ref="header" class="file-title file-title-flex-parent">
      <div class="file-header-content align-content-center gl-flex gl-flex-wrap overflow-hidden">
        ...
        <template v-if="filePath">
          ...
          <strong class="file-title-name limited-width gl-inline-block overflow-hidden">
