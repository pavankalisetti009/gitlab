...
gem 'fog-google', '~> 1.27.0', require: 'fog/google', feature_category: :shared # rubocop:todo Gemfile/MissingFeatureCategory -- https://gitlab.com/gitlab-org/gitlab/-/issues/581839
...
gem 'gitlab-labkit', '~> 1.1.3', feature_category: :shared # rubocop:todo Gemfile/MissingFeatureCategory -- https://gitlab.com/gitlab-org/gitlab/-/issues/581839
...
gem "gitlab-cloud-connector", "~> 1.42", require: 'gitlab/cloud_connector', feature_category: :plan_provisioning
